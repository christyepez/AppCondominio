...
{
    private SupplierPayable(Guid id,Guid communityId,Guid supplierId,string documentNumber,DateOnly documentDate,DateOnly dueDate,decimal originalAmount,string expenseAccount,string payableAccount):base(id){CommunityId=communityId;SupplierId=supplierId;DocumentNumber=documentNumber;DocumentDate=documentDate;DueDate=dueDate;OriginalAmount=OutstandingAmount=originalAmount;ExpenseAccount=expenseAccount;PayableAccount=payableAccount;}
